...
#include "../../Bank/databasemanager.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSDatabaseManagerENDCLASS_t qt_meta_stringdata_CLASSDatabaseManagerENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(16, 13),  // "tablesCleared"
        QT_MOC_LITERAL(30, 0)   // ""
    },
    "DatabaseManager",
    "tablesCleared",
...
void DatabaseManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &DatabaseManager::tablesCleared; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DatabaseManager::tablesCleared()
{
